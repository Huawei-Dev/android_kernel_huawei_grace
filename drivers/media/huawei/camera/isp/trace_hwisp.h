...
DECLARE_EVENT_CLASS(hwisp_stream_buf_internel,  /* [false alarm]:linux origin code,declare class,not a func */
    ...
    TP_printk("pixfmt=%d phy=%d "
              "handle=%pK y_addr=%pK u_addr=%pK v_addr=%pK",
              __entry->pixfmt, __entry->phy, 
              __entry->handle, (void*)__entry->y_addr, (void*)__entry->u_addr, (void*)__entry->v_addr)
);

...
static irqreturn_t k3_csi0_isr(int irq, void *dev_id)
{
	...
	if (100 == csi0_err_cnt ){
        ...
        if (0 == (csi0_err_cnt % 100))
        {
            ...
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x0),CSI_GETREG32((CSI0_REG_BASE + 0x0)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x4),CSI_GETREG32((CSI0_REG_BASE + 0x4)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x8),CSI_GETREG32((CSI0_REG_BASE + 0x8)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0xc),CSI_GETREG32((CSI0_REG_BASE + 0xc)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x10),CSI_GETREG32((CSI0_REG_BASE + 0x10)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x14),CSI_GETREG32((CSI0_REG_BASE + 0x14)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x18),CSI_GETREG32((CSI0_REG_BASE + 0x18)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x1c),CSI_GETREG32((CSI0_REG_BASE + 0x1c)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x20),CSI_GETREG32((CSI0_REG_BASE + 0x20)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x24),CSI_GETREG32((CSI0_REG_BASE + 0x24)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x28),CSI_GETREG32((CSI0_REG_BASE + 0x28)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x2c),CSI_GETREG32((CSI0_REG_BASE + 0x2c)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x30),CSI_GETREG32((CSI0_REG_BASE + 0x30)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI0_REG_BASE + 0x34),CSI_GETREG32((CSI0_REG_BASE + 0x34)));
        }
...
static irqreturn_t k3_csi1_isr(int irq, void *dev_id)
{
	...
	if (100 == csi1_err_cnt ){
        ...
        if (0 == (csi1_err_cnt % 100))
        {
            ...
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x0),CSI_GETREG32((CSI1_REG_BASE + 0x0)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x4),CSI_GETREG32((CSI1_REG_BASE + 0x4)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x8),CSI_GETREG32((CSI1_REG_BASE + 0x8)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0xc),CSI_GETREG32((CSI1_REG_BASE + 0xc)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x10),CSI_GETREG32((CSI1_REG_BASE + 0x10)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x14),CSI_GETREG32((CSI1_REG_BASE + 0x14)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x18),CSI_GETREG32((CSI1_REG_BASE + 0x18)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x1c),CSI_GETREG32((CSI1_REG_BASE + 0x1c)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x20),CSI_GETREG32((CSI1_REG_BASE + 0x20)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x24),CSI_GETREG32((CSI1_REG_BASE + 0x24)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x28),CSI_GETREG32((CSI1_REG_BASE + 0x28)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x2c),CSI_GETREG32((CSI1_REG_BASE + 0x2c)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x30),CSI_GETREG32((CSI1_REG_BASE + 0x30)));
            print_error("reg [%pK] = [%#x]\n",(void*)(CSI1_REG_BASE + 0x34),CSI_GETREG32((CSI1_REG_BASE + 0x34)));
        }
...
int ispv1_get_resource(void)
{
	...
	print_debug("exit %s, csi0_base[%pK]", __func__, (void*)ispv1_io.csi0_base);
...
int ispv1_io_power_init(char *ldo_name, u32 vol_min, u32 vol_max)
{
	...
	print_info("Enter %s, register LDO. dev[%pK]", __func__, &(ispv1_io.pdev->dev));
...
int ispv1_io_hw_init(struct platform_device *pdev)
{
	...
	print_debug("enter %s, pdev[%pK]", __func__, pdev);
...
void ispv1_io_reset_phy(csi_index_t index, csi_lane_t mipi_lane_count)
{
     ...
     print_info("enter %s  index %d reg_base %pK",__func__, index, reg_base);
